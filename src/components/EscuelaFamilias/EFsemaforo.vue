    ...
    <form action="">
        ...
        <div>
            ...
            <p>Movilidad. ¿Tiene una apertura de menos de 30º?</p>
                <input type="radio" id="aperturaSI" name="apertura" value="aperturaSI">
                    <label for="aperturaSI">Sí</label>
                <input type="radio" id="aperturaNO" name="apertura" value="aperturaNO">
