<template>
    <p>La confidencialidad y la seguridad son valores primordiales de CENTRO INTERNACIONAL DEL PERTHES y, 
        en consecuencia, asumimos el compromiso de garantizar la privacidad del Usuario en todo momento y 
        de no recabar información innecesaria. A continuación, le proporcionamos toda la información necesaria 
        sobre nuestra Política de Privacidad en relación con los datos personales que recabamos, explicándole:
        <pre>
        ...
        <pre>
            CENTRO INTERNACIONAL DEL PERTHES, S.L. (B0XXXXXXX) 

            Plaza Puerta del Sol, 

            28013 Madrid

            doctor.CIP.pherthes@gmail.com


            Finalidades, legitimación y conservación de los tratamientos de los datos enviados a través de:
            ...
            Conservación: Hasta una vez resulta su solicitud por medio de nuestro formulario o contestada por correo electrónico, si no ha generado un nuevo tratamiento. En caso de haber aceptado recibir envíos comerciales, hasta que solicite la baja de los mismos.

            FORMULARIO DE REGISTRO

            Finalidad: Darle de alta como usuario y permitirles el acceso a los servicios reservados a usuarios registrados de nuestra web e informarle de nuestras actividades, productos y servicios, así como enviarle comunicaciones comerciales de nuestros productos, servicios inclusive por medios electrónicos), si marca la casilla de aceptación.

            Legitimación: El consentimiento del usuario al registrarse a través de nuestro formulario de registro y al marcar la casilla de aceptación de envío de información.
            ...
            Finalidades: Publicar su comentario en el blog de la página web, así como enviarle comunicaciones de nuestros productos, servicios y actividades, inclusive por medios electrónicos, si marca la casilla de aceptación.

            Legitimación: El consentimiento del usuario al rellenar el formulario de contactos y al marcar la casilla de aceptación de envío de información.

            Conservación: Mientras la publicación en el blog esté publicada en la página web. En caso de haber aceptado recibir envíos comerciales, hasta que solicite la baja de los mismos.
            ...
            ENVÍO DEL CURRÍCULUM VITAE POR CORREO ELECTRÓNICO.

            Finalidad: Disponer de su currículum para participar en nuestros procesos de selección de personal.

            Legitimación: El consentimiento del usuario al remitirnos su información personal y currículum para nuestros procesos de selección de personal.

            Conservación: Durante el desarrollo de los procesos de selección de personal abiertos y durante 1 año para futuros procesos.
            ...
            En caso de divergencias con la empresa en relación con el tratamiento de sus datos, puede presentar una reclamación ante la Autoridad de Protección de Datos (https://www.aepd.es/es).


            Cookies

            Esta página web, únicamente utiliza cookies técnicas, de personalización y análisis, propias y de terceros (Google Analytics), que en ningún caso tratan datos de carácter personal ni captan hábitos de navegación para fines publicitarios.

            Por ello, al acceder a nuestra web, en cumplimiento del artículo 22 de la Ley de Servicios de la Sociedad de la Información, al tratar cookies de análisis, le hemos solicitado su consentimiento para su uso y facilitado información de las mismas, que en todo caso se instalarán pasado un plazo de tiempo prudencial para que el usuario tenga tiempo de decidir prestar su consentimiento o no.
